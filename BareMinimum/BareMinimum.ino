...
void setup() {
  ...
  lcd.begin(2, 16);           // Initialize LCD type (x columns, y rows)
...
void loop() {
  ...
  lcd.print("Press to begin");  // Display instruction to the player
...
void reactionGame() {
  ...
  lcd.clear();
  lcd.print("press button fast");  // Ask the player to press the button as fast as possible
